...
# Read the data file.
filename = 'T1266.xml' # exported density file
...
with PdfPages('densities-oneplot.pdf') as pdf:
    ...
    h = sns.heatmap(density_array, cmap="RdBu_r", vmin=density_min, vmax=density_max, yticklabels=range(1,31,+1), xticklabels=temperatures)
